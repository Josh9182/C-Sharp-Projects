...
builder.Services.AddSingleton<ServiceData>(); // Singleton lifetime linking the Dependency Injection class, ServiceData to the application builder
builder.Services.AddSingleton<DriverContainer>(); // Singleton lifetime linking the Automation class, SeleniumAutomation to the application builder
